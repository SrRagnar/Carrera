...
//Expresion del menu de opciones segun sea un grafo dirigido o no dirigido
{
    ...
    if (dirigido == 0) //Grafo no dirigido
            ...
            std::cout << "k. Realizar el MST a traves del algoritmo de kruskal" << std::endl;
	    //Aqu� se a�aden m�s opciones al men� del grafo no dirigido
            ...
            std::cout << "P. Realiar los caminos minimos de un grafo, partiendo de un nodo dado, a traves del algoritmo PDM" << std::endl;
    ...
    else
    {
        ...
        do
        {
            ...
            switch (opcion)
            {
                ...
                case 'k' :
                  if (G.Es_dirigido()) {
                    std::cout << "Esta opcion solo esta disponible para grafos no dirigidos." << std::endl;
                    std::cout << "Pulse enter para continuar .....";
                    std::cin.ignore(); 
                    std::cin.get();
                    system("clear");
                ...
                case 'P' :
                  if (!G.Es_dirigido()) {
                    std::cout << "Esta opcion solo esta disponible para grafos dirigidos." << std::endl;
                    std::cout << "Pulse enter para continuar .....";
                    std::cin.ignore(); 
                    std::cin.get();
                    system("clear");
