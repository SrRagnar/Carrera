...
/**
  * @brief Este metodo calcula el cuadrado del racional que lo llame.
  *
  * @return El resultado del cuadrado.
  */

rational_t rational_t::Square(void) {
  rational_t resultado_cuadrado;
  resultado_cuadrado.set_num(get_num() * get_num());
  resultado_cuadrado.set_den(get_den() * get_den());
